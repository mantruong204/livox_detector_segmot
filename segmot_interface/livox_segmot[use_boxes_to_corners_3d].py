...
class ros_demo():
    ...
    def image_callback(self, data):
        ...
        if len(self.boxes) > 0:
            corners_3d_list = boxes_to_corners_3d(self.boxes)

            for corners_3d in corners_3d_list:
                print(f"corners_3d = {corners_3d}")
                if (corners_3d[0][1]+corners_3d[2][1])/2 > -2.0:  # The object is too close to the camera, ignore it during visualization
                    continue
    ...
    def online_inference(self, request: detectionRequest):
        ...
        # print(f"boxes = {boxes_to_corners_3d(boxes)}")
